...
function goto_page()
{
        if(true){
			...
			<script language="JavaScript1.2" type="text/javascript">
				...
				window.location = "http://www.cs.indiana.edu/cgi-pub/ggomatom/eventpostingpage.php";
			</script>
			<?php
...
$sql="INSERT INTO Events(name,upperlimit,lowerlimit,category,owner,start_time,end_time,description) values('$_POST[EventName]','$_POST[UpperLimit]','$_POST[LowerLimit]','$_POST[category]','chinmay','$_POST[startdate]','$_POST[enddate]','$_POST[Description]')";
