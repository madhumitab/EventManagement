...
if ($cat=="sports") {$sql = "SELECT name,eid FROM Events where end_time > now() and category='Sports' ORDER BY start_time DESC LIMIT $start_from, 5";} 

else if ($cat=="concerts") {$sql = "SELECT name,eid FROM Events where end_time > now() and category='Concerts' ORDER BY start_time DESC LIMIT $start_from, 5";} 

else if ($cat=="outdoor") {$sql = "SELECT name,eid FROM Events where end_time > now() and category='Outdoor' ORDER BY start_time DESC LIMIT $start_from, 5";} 

else if ($cat=="party") {$sql = "SELECT name,eid FROM Events where end_time > now() and category='Parties' ORDER BY start_time DESC LIMIT $start_from, 5";} 
